...
const PrivacyPolicy = () => {
  ...
  return (
    <ScrollView
      ...
      <Headline style={styles.subHeading}>Privacy Policy</Headline>
      <Title style={styles.subHeading}>Our Commitment To You</Title>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        At DateX, your privacy is top priority. Your privacy is at the core of
        the way we design and build the services and products you know and love,
        so that you can fully trust them and build meaningful connections.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        policies. We take the exact opposite approach: we have written our
        Privacy Policy and related documents in plain language. We actually want
        you to read our policies and understand our privacy practices!
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        Welcome to the DateX Privacy Policy. Thank you for taking the time to
        ...
        to a minimum. This Privacy Policy applies beginning 1st September, 2021.
      </Paragraph>

      <Subheading style={styles.subHeading}>1. Who We Are</Subheading>
      <Text style={styles.text}>
        The company that is responsible for your information under this Privacy
        Policy is:
      </Text>
      <Text style={styles.text}>DateX Inc.</Text>
      <Text style={styles.text}>KNUST</Text>
      <Text style={styles.text}>Kumasi</Text>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        This Privacy Policy applies to apps, events and other services operated
        by DateX. For simplicity, we refer to all of these as our “services” in
        this Privacy Policy. Some services may require their own unique privacy
        policy. If a particular service has its own privacy policy, then that
      ...
      <Paragraph style={[styles.text, styles.subHeading]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        credentials, as well as some basic details necessary for the service to
        work, such as your gender and date of birth.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        and other details about you, as well as content such as photos. To add
        certain content, like pictures, you may allow us to access your camera
        or photo album. Some of the information you choose to provide us may be
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        other people (for example, if you ask us to send an email on your behalf
        to one of your friends), we collect the information about others that
        you give us in order to complete your request.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        to create and log into your DateX account. This saves you from having to
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        DateX ads are published on a partner’s websites and platforms (in which
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        use them for things such as authenticating you, remembering your
        preferences and settings, analyzing site traffic and trends, delivering
        and measuring the effectiveness of advertising campaigns, allowing you
        to use social features and how you can better control their use, through
        your browser settings and other tools. Some web browsers (including
        Safari, Internet Explorer, Firefox and Chrome) have a “Do Not Track”
        (“DNT”) feature that tells a website that a user does not want to have
        his or her online activity tracked. If a website that responds to a DNT
        signal receives a DNT signal, the browser can block that website from
        collecting certain information about the browser’s user. Not all
        browsers offer a DNT option and DNT signals are not yet uniform. For
        this reason, many businesses, including DateX, do not currently respond
        to DNT signals.
      </Paragraph>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        For more information on our profiling and
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        automated decision-making, please see our FAQ.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Paragraph style={[styles.text, styles.subHeading]}>
        To provide new DateX services to you
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        Register you and display your profile on new DateX features and apps
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        is stuff that you’re comfortable being publicly viewable. Neither you
        nor we can control what others do with your information once you share
        it. If you choose to limit the audience for all or part of your profile
        or for certain content or information about you, then it will be visible
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        readable form to advertising partners. We follow a strict vetting
        process prior to engaging any service provider or working with any
        partner. All of our service providers and partners must agree to strict
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        DateX is part of the Match Group family of businesses which, as of the
        date of this Privacy Policy, includes websites and apps such as Tinder,
        OkCupid, Plenty of Fish, Match, Meetic, BlackPeopleMeet, LoveScout24,
        OurTime, Pairs, ParPerfeito, and Twoo. We share your information with
        other Match Group companies for them to assist us in processing your
        information, as service providers, upon our instructions and on our
        behalf. Assistance provided by other Match Group companies may include
        technical processing operations, such as data hosting and maintenance,
        customer care, marketing and targeted advertising, finance and
        accounting assistance, better understanding how our service is used and
        users’ behavior to improve our service, securing our data and systems
        and fighting against spam, abuse, fraud, infringement and other
        wrongdoings. We may also share information with other Match Group
        companies for legitimate business purposes such as corporate audit,
        analysis and consolidated reporting as well as compliance with
        applicable laws. We may also share user information with other Match
        Group companies to remove users who violate our terms of service, or
        have been reported for criminal activity and/or bad behavior. In some
        instances, we may remove that user from all platforms.
      </Paragraph>
      <Paragraph style={[styles.text, styles.subHeading]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        (i) if disclosure would mitigate our liability in an actual or
        threatened lawsuit;{' '}
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        (ii) as necessary to protect our legal rights and legal rights of our
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        (iv) to investigate, prevent, or take other action regarding illegal
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        the information. We may use and share non-personal information (meaning
        information that, by itself, does not identify who you are such as
        ...
        We may also share this information with other Match Group companies and
      ...
      <Subheading style={styles.subHeading}>8. Your Rights</Subheading>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        us and that’s associated with your account directly within the service.
        If you have any question on those tools and settings, please contact our
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        location services as well as push notifications.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        You can change your settings on your device to either consent or oppose
        the collection of the corresponding information or the display of the
        corresponding notifications. Of course, if you do that, certain services
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        right to review the personal information we keep about you (depending on
        the jurisdiction, this may be called right of access, right of
        portability or variations of those terms). You can request a copy of
        your personal information by putting in such a request.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        Updating your information. If you believe that information we hold about
        you is inaccurate or that we are no longer entitled to use it and want
        to request its rectification, deletion or object to its processing,
        please contact us. For your protection and the protection of all of our
        users, we may ask you to provide proof of identity before we can answer
        the above requests.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        consent before the information is released. Also, we may not be able to
        accommodate certain requests to object to the processing of personal
        information, notably where such requests would not allow us to provide
        our service to you anymore. For instance, we cannot provide our service
        if we do not have your date of birth.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        re-install the application on the same mobile device, we will be able to
        re-associate this identifier to your previous transactions and
        activities.
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        Accountability. You have a right to lodge a complaint with the
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        information is no longer secure, please notify us immediately. In order
        to ensure that our systems and your information are protected against
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        ...
        by applicable law. To protect the safety and security of our users on
        and off our services, we implement a safety retention window of three
        months following account deletion. During this period, account
        information will be retained although the account will of course not be
      ...
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        Q. we must keep it to comply with applicable law (for instance, some
        “traffic data” is kept for one year to comply with statutory data
        retention obligations);
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        R. we must keep it to evidence our compliance with applicable law (for
        instance, records of consents to our Terms, Privacy Policy and other
        similar consents are kept for five years);
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        S. there is an outstanding issue, claim or dispute requiring us to keep
        the relevant information until it is resolved; or
      </Paragraph>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        T. the information must be kept for our legitimate business interests,
        ...
        account. Keep in mind that even though our systems are designed to carry
        out data deletion processes according to the above guidelines, we cannot
        promise that all data will be deleted within a specific time frame due
        to technical constraints.
      </Paragraph>

      <Subheading style={styles.subHeading}>11. Children's Privacy</Subheading>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
      ...
      <Subheading style={styles.subHeading}>13. How to Contact Us</Subheading>
      <Paragraph style={[styles.text, {color: currentTheme.txtColor}]}>
        If you have questions about this Privacy Policy, you can reach us on our
        Contact Us screen.
      </Paragraph>
      <Paragraph style={{color: 'transparent'}}>
        sagsgfsdgsdfgsdfgsdfgsdfgsdfgsdfgsdfgsdfgsdfgsfdgsdfasdfasdfsafdsdfadsfasdfasdf
      </Paragraph>
    </ScrollView>
  );
};

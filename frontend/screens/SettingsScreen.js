          ...
          <View style={{marginVertical: 5}}>
            ...
            <View
              style={[
                ...
                {
                  borderRadius: 30,
                  borderColor: currentTheme.tabInactive,
              ...
              <View
                ...
                <View
                  ...
                  <Text
                    style={[styles.buttonTxt, {color: currentTheme.txtColor}]}>
                    Dark Theme
                  </Text>
                  <Switch
          ...
          <View style={{marginVertical: 5}}>
            ...
            <View
              ...
              <Pressable
                ...
                style={[
                  styles.button,
                  {borderBottomWidth: 0.5, borderColor: '#d4d4d4'},
                ]}>
                <Image
